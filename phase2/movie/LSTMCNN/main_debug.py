...
if __name__ == '__main__':
    ...
    # Training parameters
    parser.add_argument('--batch_size', type=int, default=10, help="Batch Size (default: 64)") #1024
    ...
    parser.add_argument('--checkpoint_every', type=int, default=10, help="Save model after this many steps (default: 100)")    #100
    parser.add_argument('--dev_size', type=float, default=0.01,
    ...
    if config.mode == 'train':
        ...
        for batch in batches:
            ...
            if current_step % config.checkpoint_every == 0:
                ...
                print('saveiter {}\tbatch  = {}/{} train loss = {:.4f}'.format(saveiter, iter, totalbatchnum, total_loss/iter))
                print('validattion time : {:.2f}\tval_data length : {}'.format(time.time()-devtime, len(y_dev)))
                print('{}'.format('#' * 30))
                saveiter += 1

        print('run time cudnn model = {:.3f}sec'.format(time.time() - start))
